...
# Change this to your secret key (can be anything, it's for extra protection)rom flask import Flask, render_template, request, redirect, url_for, session,flash
...
app.config['MYSQL_HOST'] = os.getenv('MYSQL_HOST', 'db')  # 'db' for Docker, 'localhost' for local
